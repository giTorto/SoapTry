 ...
 *       &lt;sequence>
 *         &lt;element name="value" type="{http://ws.document.introsde/}healthMeasureHistory" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ReadPersonMeasurementResponse {
    ...
    protected List<HealthMeasureHistory> value;
     ...
     * 
     */
    public List<HealthMeasureHistory> getValue() {
        if (value == null) {
            value = new ArrayList<HealthMeasureHistory>();
        }
        return this.value;
    }
